...
import kotlinx.android.synthetic.main.gif_fullscreen.ivFullscreen
...
class FullscreenFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as GifActivity).fabUpload.hide()
    }
    ...
    override fun onDetach() {
        (activity as GifActivity).fabUpload.show()
        super.onDetach()
    }
    ...
    private fun show() {
        // Show the system bar
        ivFullscreen?.systemUiVisibility =
